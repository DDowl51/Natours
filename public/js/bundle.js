...
var showAlert = function showAlert(type, message) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // Close alert after 5s
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGRvd2wiLCJhIjoiY2w3NHVub3lpMWx5NzN2bXEzczU1ZnZqMiJ9.8VpUz-_o9VouKedols6n1A';
  ...
  locations.forEach(function (loc) {
    ...
    var popup = new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // include current location
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // alert(`You are login with ${email} ${password}`);
            token = document.querySelector('.token').dataset.token;
            console.log(token);
            _context.prev = 2;
            _context.next = 5;
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/users/confirm/".concat(token)
            });
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              document.querySelector('.message_msg').textContent = 'Account confirmed successfully! Now going to main page.';
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 9:
            ...
            document.querySelector('.message_msg').textContent = "Error: ".concat(_context.t0.response.data.message);
...
var stripe = Stripe('pk_test_51Lct7FEz3UnqBgewi8atdAx6dnLKGjS1n6QphZbrlbIstPUiFpmcJ5fdz5xuUWWVfVe6aRwcyX8HQfdAl7dd3q0800fZp66zBS');
...
var confirmAccountForm = document.querySelector('.message--confirm-account');
var bookBtn = document.getElementById('book-tour');
var cardContainer = document.querySelector('.card-container');
var navBtn = document.querySelector('.nav--btn'); // Values
// Delegation
...
if (cardContainer) {
  var overlays = document.querySelectorAll('.card__picture-overlay');

  if (overlays) {
    Array.from(overlays).forEach(function (overlay) {
      var image = overlay.nextSibling;
...
},{"./login":"login.js","./signup":"signup.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./confirm":"confirm.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
